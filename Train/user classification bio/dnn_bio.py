...
joblib.dump(tfidf_vectorizer,'tfidf_bio.joblib.pkl')
...
joblib.dump(lb,'lb_bio.joblib.pkl')
#Transforming labels
...
callbacks = [
    ...
    keras.callbacks.ModelCheckpoint('Bio3layer256', monitor='val_loss', save_best_only=True, verbose=1),
]

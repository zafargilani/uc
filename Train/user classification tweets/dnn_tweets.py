...
joblib.dump(tfidf_vectorizer,'tfidf_tweets.joblib.pkl')
...
joblib.dump(lb,'lb_tweets.joblib.pkl')
#Transforming labels
...
callbacks = [
    ...
    keras.callbacks.ModelCheckpoint('Tweets_weights.h5', monitor='val_loss', save_best_only=True, verbose=1),
]
